...
\begin{center}
    ...
    \small  \href{mailto:hungho2812@gmail.com}{\underline{hungho2812@gmail.com}} $|$ (+358) 504488109  $|$
...
\section{Professional Summary}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     {Front-end developer with extensive experience in ReactJS and TypeScript, specializing in building dynamic, high-performance web applications. Proven track record of delivering scalable and maintainable solutions using modern frameworks like ReactJS, NextJS, and AWS. Adept at both front-end and back-end integration, with  knowledge of web standards and agile development methodologies.} \\
    }}
 \end{itemize}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Backend}{: Node.js, Express, FastAPI, Spring Boot (Basic), AWS Lambda} \\
